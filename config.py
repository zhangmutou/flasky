...
class Config:
    ...
    #     },
    #     'disks': {
    #         'task': 'app.workers.server_monitor_worker.disks',
    #         # 'schedule': crontab('*/2')
    #         'schedule': timedelta(seconds=3)
    #     },
    #     'network': {
    #         'task': 'app.workers.server_monitor_worker.network',
    #         # 'schedule': crontab('*/2')
    #         'schedule': timedelta(seconds=3)
    #     },
    #     'sensors': {
    #         'task': 'app.workers.server_monitor_worker.sensors',
    #         # 'schedule': crontab('*/2')
    #         'schedule': timedelta(seconds=3)
    #     },
    }
